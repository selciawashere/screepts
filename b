...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.LocalPlayer:Kick("Bypassin | Rejoin")
    end
end
    ...
    LPH_JIT_MAX(function()
        ...
        if Game_Name == "The Bronx" then
            ...
            HideUI = LPH_NO_VIRTUALIZE(function(Title, Timing)
                ...
                textLabel.Text = '\n<font color="rgb(255,0,0)">Bypassin</font>\n' .. Title
...
local Library, Flags = loadstring(game:HttpGet("https://raw.githubusercontent.com/selciawashere/screepts/refs/heads/main/a"))() -- uii

-- \\ Script

local window = Library:Window({Prefix = "Bypass", Suffix = "in"})
            ...
            Callback = function(toggle)
                ...
                if usernameLabel and usernameLabel:IsA("TextLabel") then
                    if toggle then
                        ...
                        usernameLabel.Text = "discord.gg/bypassin"
                    else
...
do -- \\ Main Page
    ...
    do -- \\ Notifications Section
        ...
        local spamMessage = "Bypassin On Top Join Discord Here - https://discord.gg/bypassin"
        local spamCount = 1
        local spamDelay = 0.1
                ...
                if state then
                    task.spawn(function()
                        ...
                        for i = 1, spamCount do
                            ...
                            pcall(function()
                                firesignal(Event.OnClientEvent, spamMessage or "Bypassin On Top Join Discord Here - https://discord.gg/bypassin", Color3.fromRGB(42, 208, 255), spamDuration)
                            end)
                            task.wait(spamDelay)
                        end
